    ...
    private static List<PointData> GetTorrentMetrics(ImmutableArray<TorrentInfo> torrents, DateTimeOffset timestamp) {
        ...
        foreach (var torrent in torrents) {
            ...
            var point = PointData.Builder
                ...
                .Field("connections_count", torrent.ConnectionsCount ?? -1)
                .Field("connections_limit", torrent.ConnectionsLimit ?? -1)
                ...
                .Field("piece_size", torrent.PieceSize ?? -1L)
                .Field("pieces_have", torrent.PiecesHave ?? -1)
                .Field("pieces_total", torrent.PiecesTotal ?? -1)
                ...
                .Field("total_wasted", torrent.TotalWasted ?? -1L)
    ...
    private static List<PointData> GetTrackerMetrics(ImmutableArray<TorrentInfo> torrents, DateTimeOffset timestamp) {
        ...
        foreach (var torrent in torrents) {
            ...
            fields
                ...
                .AddOrIncrement("connections_count", torrent.ConnectionsCount ?? 0)
                ...
                .AddOrIncrement("piece_size", torrent.PieceSize ?? 0L)
                .AddOrIncrement("pieces_have", torrent.PiecesHave ?? 0)
                .AddOrIncrement("pieces_total", torrent.PiecesTotal ?? 0)
                ...
                .AddOrIncrement("total_wasted", torrent.TotalWasted ?? 0)
